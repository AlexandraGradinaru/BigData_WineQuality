...
wine <- read_csv2("wine.csv") #upload dataset
...
table(wine_clas_test$alcohol) # 35% of wines have alchohol percentage > 10%
...
confusionMatrix(factor(pred_c1$class), factor(wine_clas_test$alcohol)) # 90% accuracy
